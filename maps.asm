...
INCLUDE "data/maps/headers/CinnabarVolcanoTop.asm"
INCLUDE "scripts/CinnabarVolcanoTop.asm"
INCLUDE "data/maps/objects/CinnabarVolcanoTop.asm"
CinnabarVolcanoTop_Blocks: INCBIN "maps/CinnabarVolcanoTop.blk"
...
INCLUDE "data/maps/headers/CinnabarVolcanoB1F.asm"
