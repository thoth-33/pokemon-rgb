...
; entries correspond to TRADE_FOR_* constants
	...
	db ELECTABUZZ, HAUNTER,   TRADE_DIALOGSET_HAPPY,     "CASPER@@@@@" ; CERULEAN CITY
	...
	db MAGMAR,     GRAVELER,  TRADE_DIALOGSET_HAPPY,     "FLINT@@@@@@" ; CINNABAR LAB
	db MAROWAK,    MACHOKE,   TRADE_DIALOGSET_HAPPY,     "APOLLO@@@@@" ; ROUTE 5
