...
ProfOakData:
; Unused
	db $FF, 66, TAUROS, 67, GENGAR, 68, VILEPLUME, 69, ELECTABUZZ, 68, NINETALES, 70, BLASTOISE, 0
	db $FF, 66, TAUROS, 67, GENGAR, 68, NINETALES, 69, ELECTABUZZ, 68, CLOYSTER,  70, VENUSAUR, 0
	db $FF, 66, TAUROS, 67, GENGAR, 68, CLOYSTER,  69, ELECTABUZZ, 68, VILEPLUME, 70, CHARIZARD, 0
