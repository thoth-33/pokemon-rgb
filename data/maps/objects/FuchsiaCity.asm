	...
	const_export FUCHSIACITY_OMANYTE
...
FuchsiaCity_Object:
	...
	object_event 28, 17, SPRITE_GAMBLER_ASLEEP, STAY, NONE, TEXT_FUCHSIACITY_GAMBLER
	...
	object_event 12,  6, SPRITE_KANGASKHAN, WALK, ANY_DIR, TEXT_FUCHSIACITY_KANGASKHAN
	object_event 30, 12, SPRITE_SLOWPOKE, WALK, ANY_DIR, TEXT_FUCHSIACITY_SLOWPOKE
	object_event  8, 17, SPRITE_LAPRAS, WALK, ANY_DIR, TEXT_FUCHSIACITY_LAPRAS
	object_event  6,  5, SPRITE_OMANYTE, STAY, ANY_DIR, TEXT_FUCHSIACITY_FOSSIL
	object_event  5, 28, SPRITE_COOLTRAINER_M, STAY, DOWN, TEXT_FUCHSIACITY_COOLTRAINER_M
