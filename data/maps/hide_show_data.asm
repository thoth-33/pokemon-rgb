...
FuchsiaCityHS:
	db FUCHSIA_CITY, FUCHSIACITY_COOLTRAINER_M, HIDE
SaffronCityHS:
	db SAFFRON_CITY, SAFFRONCITY_ROCKET1,        SHOW
	db SAFFRON_CITY, SAFFRONCITY_ROCKET2,        SHOW
	db SAFFRON_CITY, SAFFRONCITY_ROCKET3,        SHOW ; Set to hide for debug
...
Route28HS:	
	...
	db ROUTE_28, ROUTE28_RARE_CANDY, SHOW
MtSilverHS:
	db MT_SILVER, MT_SILVER_ERIKA,        HIDE
	db MT_SILVER, MT_SILVER_BLAINE,       HIDE
	db MT_SILVER, MT_SILVER_KOGA,         HIDE
	db MT_SILVER, MT_SILVER_CAVE_GUARD1,  SHOW ; set to hide for debug
	db MT_SILVER, MT_SILVER_CAVE_GUARD2,  HIDE
	db MT_SILVER, MT_SILVER_WEEZING1,     SHOW
	db MT_SILVER, MT_SILVER_WEEZING2,     SHOW
	db MT_SILVER, MT_SILVER_FULL_RESTORE, SHOW
CinnabarVolcanoTopHS:
	db CINNABAR_VOLCANO_TOP, CINNABARVOLCANOTOP_MOLTRES, SHOW
BluesHouseHS:
...
PewterGymHS:
	db PEWTER_GYM, PEWTERGYM_BROCK1,     SHOW
	db PEWTER_GYM, PEWTERGYM_BROCK2,     HIDE
...
CeruleanGymHS:
	db CERULEAN_GYM, CERULEANGYM_MISTY1, SHOW
	db CERULEAN_GYM, CERULEANGYM_MISTY2, HIDE
VermilionGymHS:
...
SSAnneBowHS:
	db SS_ANNE_BOW, SSANNEBOW_OAK, HIDE
SSAnne1FRoomsHS:
...
MtSilver1FHS:
	db MT_SILVER_CAVE_1F, MT_SILVER1F_HYPNO,     SHOW
	db MT_SILVER_CAVE_1F, MT_SILVER1F_BROCK,     HIDE
	db MT_SILVER_CAVE_1F, MT_SILVER1F_SABRINA,   HIDE
	db MT_SILVER_CAVE_1F, MT_SILVER1F_BOULDER1B, SHOW
	db MT_SILVER_CAVE_1F, MT_SILVER1F_BOULDER2B, SHOW
	db MT_SILVER_CAVE_1F, MT_SILVER1F_BOULDER3B, SHOW
	db MT_SILVER_CAVE_1F, MT_SILVER1F_BOULDER1A, HIDE
	db MT_SILVER_CAVE_1F, MT_SILVER1F_BOULDER2A, HIDE
	db MT_SILVER_CAVE_1F, MT_SILVER1F_BOULDER3A, HIDE
MtSilver2FHS:
	db MT_SILVER_CAVE_2F, MT_SILVER2F_WHIRLPOOL1,     SHOW
	db MT_SILVER_CAVE_2F, MT_SILVER2F_WHIRLPOOL2,     SHOW ; set to hide for debug
...
CinnabarVolcanoHS:
	...
	db CINNABAR_VOLCANO, CINNABARVOLCANO_BOULDER3,   SHOW
	db CINNABAR_VOLCANO, CINNABARVOLCANO_BOULDER4,   SHOW
	db CINNABAR_VOLCANO, CINNABARVOLCANO_FIRE_STONE, SHOW
	db $FF, $01, SHOW ; end
