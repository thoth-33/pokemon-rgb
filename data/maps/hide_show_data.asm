...
SaffronCityHS:
	...
	db SAFFRON_CITY, SAFFRONCITY_ROCKET3,        HIDE ; Set to hide for debug
...
MtSilverHS:
	...
	db MT_SILVER, MT_SILVER_CAVE_GUARD1,  HIDE ; set to hide for debug
...
MtSilver2FHS:
	...
	db MT_SILVER_CAVE_2F, MT_SILVER2F_WHIRLPOOL2,     HIDE ; set to hide for debug
