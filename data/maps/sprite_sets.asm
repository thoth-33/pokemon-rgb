...
MapSpriteSets:
	...
	db SPRITESET_PALLET_VIRIDIAN ; ROUTE_28
	db SPRITESET_PALLET_VIRIDIAN ; MT.SILVER
...
SplitMapSpriteSets:
	...
	db NORTH_SOUTH, 19, SPRITESET_LAVENDER,        SPRITESET_SILENCE_BRIDGE  ; SPLITSET_ROUTE_12
