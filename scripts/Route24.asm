...
Route24_TextPointers:
	...
	dw_const Route24BadTrainerText,    TEXT_ROUTE24_BADTRAINER
...
Route24BadTrainerText:
	text_asm
	CheckEvent EVENT_CHARMANDER
	jr nz, .AlreadyHaveCharmander
	ld hl, Route24Text_Damian1
	call PrintText
	ld a, [wRivalStarter]
	cp $B1 ; Rival got Squirtle
	jr z, .startedWithCharmander
	ld hl, Route24Text_Damian5
	call PrintText
	call YesNoChoice
	ld a, [wCurrentMenuItem]
	and a
	jr nz, .CharmanderRefused
	ld a, CHARMANDER
	ld [wd11e], a
	ld [wcf91], a
	call GetMonName
	...
	call PrintText
	SetEvent EVENT_CHARMANDER
.startedWithCharmander
	jp TextScriptEnd
