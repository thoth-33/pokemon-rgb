...
; Post Game events and Volcano events
	...
	const EVENT_ERIKA_REMATCH_BEAT
	const EVENT_BLAINE_REMATCH
	const EVENT_BLAINE_REMATCH_BEAT
	const EVENT_KOGA_REMATCH
	const EVENT_KOGA_REMATCH_BEAT
	const EVENT_BROCK_REMATCH
	const EVENT_BROCK_REMATCH_BEAT
	const EVENT_SABRINA_REMATCH
	const EVENT_SABRINA_REMATCH_BEAT
	const EVENT_MISTY_REMATCH
	const EVENT_MISTY_REMATCH_BEAT
	const EVENT_GIOVANNI_REMATCH_BEAT
	const EVENT_OAK_BEAT
	const EVENT_BEAT_MOLTRES 
	const EVENT_BEAT_MT_SILVER3F_ROCKET1
	const EVENT_BEAT_MT_SILVER3F_ROCKET2
	const EVENT_BEAT_MT_SILVER3F_ROCKET3
	const EVENT_VOLCANO_BOULDER1_DOWN_HOLE
	const EVENT_VOLCANO_BOULDER2_DOWN_HOLE
	const EVENT_VOLCANO_BOULDER3_DOWN_HOLE
	const EVENT_VOLCANO_BOULDER4_DOWN_HOLE
	const EVENT_E4_REMATCH
