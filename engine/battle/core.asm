...
.selectedmoveknown
	...
	cp LINK_STATE_BATTLING
	jr z, .matchedkeyspicked
	; Disable left, right, and PAD_START buttons in regular battles.
	ld a, [wStatusFlags7]
...
.calcCriticalHitProbability
	...
	jr z, .noFocusEnergyUsed     ; FIXED: using focus energy causes a shift to the right instead of left resulting in 1/4 the usual crit chance
...
; FIXED: The fix for Swift broke this code. It's supposed to prevent HP draining moves from working on Substitutes.
